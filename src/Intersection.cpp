...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    // FP.6c : Use the methods TrafficLight::getCurrentPhase and TrafficLight::waitForGreen to block the execution until the traffic light turns green.
    // DONE
...
{
    // FP.6b : In method Intersection::simulate(), start the simulation of private member variable _trafficLight
    //DONE
